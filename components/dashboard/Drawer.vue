  ...
  <aside class="w-72 min-h-full bg-white border-r border-slate-200/80 flex flex-col justify-between select-none shadow-sm">
    <div class="p-5 flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-5">
        <div>
          <p class="text-[11px] font-bold text-slate-400 uppercase tracking-wider px-3 mb-2">Hệ thống</p>
        ...
        <div>
          <p class="text-[11px] font-bold text-slate-400 uppercase tracking-wider px-3 mb-2">Hỗ trợ & Tài liệu</p>
          <div class="flex flex-col gap-1">
            <NuxtLink
              to="/info"
              :class="[
