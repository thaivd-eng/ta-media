...
<template>
  <div class="rounded border w-full flex flex-col aspect-[4/3] overflow-hidden">
    <NuxtLink :to="'/project?id=' + props.project.id" class="grow flex justify-center items-center bg-base-200">
      <img :src="props.project.thumbnailUrl" alt="thumb" class="w-full h-full" v-if="props.project.thumbnailUrl">
