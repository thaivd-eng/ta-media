...
<template>
  <div class="rounded border w-full flex flex-col aspect-[4/3]">
    <NuxtLink :to="'/video?id=' + props.video.id" class="relative grow flex justify-center items-center bg-base-200">
      <img :src="props.video.thumbnailUrl" alt="thumb" class="rounded-t w-full h-full" v-if="props.video.thumbnailUrl">
